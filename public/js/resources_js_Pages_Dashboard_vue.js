...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    BoardList: function BoardList() {
      return __webpack_require__.e(/*! import() */ "resources_js_Components_BoardList_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./../Components/BoardList.vue */ "./resources/js/Components/BoardList.vue"));
    }
  },
  data: function data() {
    return {
  ...
  methods: {
    initBoards: function initBoards() {
      var _this = this;
      axios.get('/sanctum/csrf-cookie');
      axios.get('/api/boards').then(function (_ref) {
        var data = _ref.data;
